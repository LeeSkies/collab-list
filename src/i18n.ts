...
const resources = {
  en: {
    translation: {
      ...
      restoreAllBody: 'Choose what else to reset while returning every product to the list.',
      ...
      deleteBody: 'This permanently deletes the product and all of its pick history.',
      ...
      noHistory: 'This product has not been bought yet.',
      pickedBy: 'Bought by {{email}}',
      lastPicked: 'Last bought {{date}}',
      today: 'today',
      yesterday: 'yesterday',
      close: 'Close',
      language: 'Language',
  ...
  he: {
    translation: {
      ...
      restoreAllBody: 'בחרו מה עוד לאפס בזמן החזרת כל המוצרים לרשימה.',
      ...
      deleteBody: 'המוצר וכל היסטוריית הקנייה שלו יימחקו לצמיתות.',
      ...
      history: 'היסטוריית קנייה',
      historyLoading: 'טוענים היסטוריה…',
      noHistory: 'המוצר עדיין לא נקנה.',
      pickedBy: 'נקנה על ידי {{email}}',
      lastPicked: 'נקנה לאחרונה {{date}}',
      today: 'היום',
      yesterday: 'אתמול',
      close: 'סגירה',
      language: 'שפה',
