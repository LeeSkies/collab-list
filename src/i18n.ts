...
const resources = {
  en: {
    translation: {
      ...
      noHistory: 'This product has not been picked yet.',
      pickedBy: 'Picked by {{email}}',
      lastPicked: 'Last picked {{date}}',
      today: 'today',
      yesterday: 'yesterday',
      close: 'Close',
      language: 'Language',
  ...
  he: {
    translation: {
      ...
      deleteBody: 'המוצר וכל היסטוריית האיסוף שלו יימחקו לצמיתות.',
      ...
      history: 'היסטוריית איסוף',
      historyLoading: 'טוענים היסטוריה…',
      noHistory: 'המוצר עדיין לא נאסף.',
      pickedBy: 'נאסף על ידי {{email}}',
      lastPicked: 'נאסף לאחרונה {{date}}',
      today: 'היום',
      yesterday: 'אתמול',
      close: 'סגירה',
      language: 'שפה',
